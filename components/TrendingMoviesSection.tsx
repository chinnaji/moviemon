  ...
  return (
    <section className="mx-auto max-w-[1200px] py-10">
      ...
      <div className="flex items-center justify-between pr-5">
        <h2 className="mb-7 ml-2 w-fit border-b text-2xl font-semibold text-zinc-200">
          Trending Movies
        </h2>

        <Link passHref href="/trending-movies">
          <a className="h-fit border-b text-zinc-100 hover:border-b-lime hover:text-lime">
            See More
          </a>
        </Link>
      </div>
