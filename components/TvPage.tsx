...
function TvPage({ tvDetails, videos }: personResType) {
  console.log(
    ...
    <main className="mx-auto max-w-[1200px] py-10 px-5 text-zinc-100">
      <section className="flex flex-wrap">
        ...
        <div className="mt-10 w-full md:mt-0 md:w-[65%] md:px-7">
          <h1 className="text-3xl font-bold">{tvDetails.name}</h1>
          <p className="text-zinc-400">{tvDetails.first_air_date}</p>
          ...
          <p className="my-3">
            <b>OVERVIEW</b>
            <br />
            <span className="text-zinc-500">{tvDetails.overview}</span>
          </p>
          {/* <p>
            <a href={`https://www.imdb.com/title/${tvDetails.imdb_id}`}>
